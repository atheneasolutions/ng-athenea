...
export class BloodPressureResultComponent implements OnInit {
  ...
  @Input() setValueAndUnlock!: (sys_value: string, dia_value: string) => void;
  ...
  checkValid(type: any) {
    ...
    if (this.checkSystolic.valid && this.checkDiastolic.valid) this.setValueAndUnlock(this.sys_value, this.dia_value)
  }
}